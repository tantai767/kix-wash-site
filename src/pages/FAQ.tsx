...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      cat: '作業について',
      questions: [
        { q: 'かなり汚れていますが、対応してもらえますか？', a: 'はい、泥汚れや黄砂、火山灰など幅広く対応しております。ただし、一般的な洗車では除去できない汚れ（ウォータースポット、イオンデポジット、塗料の付着など）については、落とすことができませんのでご了承ください。' },
        { q: 'どんな車でも洗車してもらえますか？', a: '空港駐車場に入庫可能なサイズであれば作業可能ですが、車高が2mを超える大型車両などの場合は作業が困難な場合がございます。ご不安な場合は、事前に店舗フリーダイヤルまでご相談ください。' },
        { q: 'バイクや自転車の洗車も可能ですか？', a: '申し訳ございません。現在は四輪自動車のみの対応となっており、バイク・自転車の洗車は承っておりません。' },
